...
// package mqttsrv provides a high performance, fully compliant MQTT v5 broker server with v3.1.1 backward compatibility.
package mqttsrv
...
func (s *Server) Serve() error {
	s.Log.Info("mqttsrv starting", "version", Version)
	defer s.Log.Info("mqttsrv server started")
...
func (s *Server) Close() error {
	...
	s.Log.Info("mqttsrv server stopped")
	return nil
}
